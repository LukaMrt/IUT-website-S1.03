...
<img src="img/data.png" data-dark="img/data-dark.png" alt="Image ordinateur" class="big-img">
...
<div class="cards">
    ...
    <custom-card class="custom-card" title="Temps de formation"
          content="1 800h de cours en plus des projets tutorés réparties en 3 ans de BUT."></custom-card>

    <custom-card class="custom-card" title="Matières enseignées"
    ...
    <custom-card class="custom-card" title="Horaires hebdomadaires"
    ...
    <custom-card class="custom-card" title="Types de cours"
    ...
    <custom-card class="custom-card" title="Prix de la formation"
    ...
    <custom-card class="custom-card" title="Organisation de l'année"
...
<article>
    ...
    <div class="prerequisites">
        <div>
            <img src="img/data.png" data-dark="img/data-dark.png" alt="Image ordinateur" id="computer">
            <p>
        ...
        <div>
            <img src="img/maths.png" data-dark="img/maths-dark.png" alt="Image mathématiques" id="maths">
            <p>
        ...
        <div>
            <img src="img/degree.png" data-dark="img/degree-dark.png" alt="Image diplôme" id="degree">
            <p>
        ...
        <div>
            <img src="img/engineer.png" data-dark="img/engineer-dark.png" alt="Image ingénieur" id="engineer">
            <p>
